...
<script>
/* Valunxt fix: scroll-to-top button visibility. The theme keeps #scroll-to-top
   at display:none and its reveal script only flips inline opacity/transform, so
   the button never appeared. We toggle a `.vxn-visible` class once the user has
   scrolled down (button then stays visible through the footer). Click-to-top is
   still handled by the theme's own .vamtam-scroll-to-top click handler. */
(function(){
...
/* Valunxt fix: trigger Elementor entrance animations on scroll.
   ...
   loaded in head.php). Uses an IntersectionObserver with a scroll-position
...
var VAMTAM_FRONT = {"ajaxurl":"<?= BASE ?>/form-handler.php","jspath":"<?= BASE ?>/assets/content/themes/execor/vamtam/assets/js/","max_breakpoint":"1025","medium_breakpoint":"768","content_width":"1280","enable_ajax_add_to_cart":"","widget_mods_list":{"button":{"label":"Button"},"icon":{"label":"Icon"},"container":{"label":"Container"},"loop-carousel":{"label":"Loop Carousel"},"nav-menu":{"label":"Nav Menu"},"form":{"label":"Form"},"toggle":{"label":"Toggle"},"text-editor":{"label":"Text Editor"},"post-comments":{"label":"Post Comments"}}};
</script>
<script src="<?= BASE ?>/assets/lib/js/jquery/jquery.min.js"></script>
<script src="<?= BASE ?>/assets/lib/js/jquery/jquery-migrate.min.js"></script>
<script src="<?= BASE ?>/assets/content/themes/execor/vamtam/assets/js/all.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor/assets/js/webpack.runtime.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor/assets/js/frontend-modules.min.js"></script>
<script src="<?= BASE ?>/assets/lib/js/jquery/ui/core.min.js"></script>
<script id="elementor-frontend-js-before">
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}},"hasCustomBreakpoints":false},"version":"4.1.2","is_static":false,"experimentalFeatures":{"e_font_icon_svg":true,"additional_custom_breakpoints":true,"container":true,"theme_builder_v2":true,"nested-elements":true,"global_classes_should_enforce_capabilities":true,"e_variables":true,"e_opt_in_v4_page":true,"e_components":true,"e_interactions":true,"e_widget_creation":true,"import-export-customization":true,"e_pro_atomic_form":true,"e_pro_variables":true,"e_pro_interactions":true},"urls":{"assets":"<?= BASE ?>\/assets\/content\/plugins\/elementor\/assets\/","ajaxurl":"<?= BASE ?>\/form-handler.php","uploadUrl":"<?= BASE ?>\/assets\/content\/uploads"},"nonces":{"floatingButtonsClickTracking":"a7e3ca7ba1","atomicFormsSendForm":"eb5257ca97"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"body_background_background":"classic","active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description","vamtam_theme_button":"yes","vamtam_theme_icon":"yes","vamtam_theme_container":"yes","vamtam_theme_loop-carousel":"yes","vamtam_theme_nav-menu":"yes","vamtam_theme_form":"yes","vamtam_theme_toggle":"yes","vamtam_theme_text-editor":"yes","vamtam_theme_post-comments":"yes"},"post":{"id":<?= (int)($PAGE['post_id'] ?? 0) ?>,"title":"<?= $PAGE['post_title'] ?? '' ?>","excerpt":"<?= $PAGE['post_excerpt'] ?? '' ?>","featuredImage":false}};
</script>
<script src="<?= BASE ?>/assets/content/plugins/elementor/assets/js/frontend.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor-pro/assets/lib/smartmenus/jquery.smartmenus.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/vamtam-elementor-integration-execor/assets/js/widgets/nav-menu/vamtam-nav-menu.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/vamtam-elementor-integration-execor/assets/js/widgets/button/vamtam-button.min.js"></script>
<script src="<?= BASE ?>/assets/lib/js/imagesloaded.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/vamtam-elementor-integration-execor/assets/js/widgets/form/vamtam-form.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor-pro/assets/js/webpack-pro.runtime.min.js"></script>
<script src="<?= BASE ?>/assets/lib/js/dist/hooks.min.js"></script>
<script src="<?= BASE ?>/assets/lib/js/dist/i18n.min.js"></script>
<script id="wp-i18n-js-after">
wp.i18n.setLocaleData( { 'text directionltr': [ 'ltr' ] } );
</script>
<script id="elementor-pro-frontend-js-before">
var ElementorProFrontendConfig = {"ajaxurl":"<?= BASE ?>\/form-handler.php","nonce":"68f45e372b","urls":{"assets":"<?= BASE ?>\/assets\/content\/plugins\/elementor-pro\/assets\/","rest":"<?= BASE ?>\/"},"settings":{"lazy_load_background_images":true},"popup":{"hasPopUps":false},"shareButtonsNetworks":{"facebook":{"title":"Facebook","has_counter":true},"twitter":{"title":"Twitter"},"linkedin":{"title":"LinkedIn","has_counter":true},"pinterest":{"title":"Pinterest","has_counter":true},"reddit":{"title":"Reddit","has_counter":true},"vk":{"title":"VK","has_counter":true},"odnoklassniki":{"title":"OK","has_counter":true},"tumblr":{"title":"Tumblr"},"digg":{"title":"Digg"},"skype":{"title":"Skype"},"stumbleupon":{"title":"StumbleUpon","has_counter":true},"mix":{"title":"Mix"},"telegram":{"title":"Telegram"},"pocket":{"title":"Pocket","has_counter":true},"xing":{"title":"XING","has_counter":true},"whatsapp":{"title":"WhatsApp"},"email":{"title":"Email"},"print":{"title":"Print"},"x-twitter":{"title":"X"},"threads":{"title":"Threads"}},"facebook_sdk":{"lang":"en_US","app_id":""},"lottie":{"defaultAnimationUrl":"<?= BASE ?>\/assets\/content\/plugins\/elementor-pro\/modules\/lottie\/assets\/animations\/default.json"}};
</script>
<script src="<?= BASE ?>/assets/content/plugins/elementor-pro/assets/js/frontend.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor-pro/assets/js/elements-handlers.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/elementor/assets/lib/dialog/dialog.min.js"></script>
<script src="<?= BASE ?>/assets/content/plugins/vamtam-elementor-integration-execor/assets/js/vamtam-elementor-frontend.min.js"></script>
<script>
/* Restore per-page active navigation state (server-rendered in WordPress, captured at build). */
<?php
/* Pages declare this path unprefixed — 'active_nav' => array('/about/') — but
 * every internal link is rewritten into the visitor's edition on the way out by
 * vxn_region_localise_links(), so the header renders /en-ae/about/. Comparing
 * the two never matched, which is why the active item only ever appeared on the
 * home pages: those live inside a region folder and so declare the prefixed
 * form already. Publish both spellings and let whichever one is on the page
 * win; the spare entry matches nothing and costs nothing.
 */
$__act = array();
foreach (($PAGE['active_nav'] ?? array()) as $__ap) {
    $__act[] = rtrim(BASE . $__ap, '/') ?: '/';
    $__act[] = rtrim(BASE . '/' . vxn_region() . $__ap, '/') ?: '/';
}
?>
window.__EXEC_ACTIVE = <?= json_encode(array_values(array_unique($__act)), JSON_UNESCAPED_SLASHES) ?>;
(function(){
...
<script src="<?= BASE ?>/assets/vendor/intl-tel-input/js/intlTelInput.min.js"></script>
<script>
