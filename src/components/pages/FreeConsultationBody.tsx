/**
 * /free-consultation/ — page body.
 *
 * Port of free-consultation/index.php. The captured Elementor markup is unchanged: the only
...
export default function FreeConsultationBody({ page, region }: { page: PageConfig; region: string }) {
  return (
    <>
      ...
      <div id="main-content">
      		...
      		<article id="post-296" className="full post-296 page type-page status-publish hentry">
      				<div data-elementor-type="single-page" data-elementor-id="3752" className="elementor elementor-3752 elementor-location-single post-296 page type-page status-publish hentry" data-elementor-post-type="elementor_library">
      		...
      		<div className="elementor-element elementor-element-7b36cfb e-con-full e-flex e-con e-child" data-id="7b36cfb" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">&gt; Book a Consultation</span>				</div>
      				</div>
      				</div>
      		...
      		<div className="elementor-element elementor-element-8c0b074 e-con-full e-flex e-con e-child" data-id="8c0b074" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h1 className="elementor-heading-title elementor-size-default">Book a Consultation</h1>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h2 className="elementor-heading-title elementor-size-default">Book a Consultation</h2>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					Connect with our advisory team to explore real estate wealth, capital, research, and technology opportunities.				</div>
      				</div>
      				</div>
      				</div>
      					</div>
      		...
      		<div className="elementor-element elementor-element-afe1311 e-con-full e-flex e-con e-parent" data-id="afe1311" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      							<div data-elementor-type="wp-page" data-elementor-id="296" className="elementor elementor-296" data-elementor-post-type="page">
      				<style id="vxn-fc-ecosystem" dangerouslySetInnerHTML={{ __html: `
      .elementor-296 .elementor-element.elementor-element-410572a > .e-con-inner{--align-items:center;align-items:center;}
      .elementor-296 .elementor-element.elementor-element-8457be8{--justify-content:flex-start!important;--gap:14px 34px!important;--row-gap:14px!important;--column-gap:34px!important;--align-items:center!important;}
      ` }} />
      		<div className="elementor-element elementor-element-410572a e-flex e-con-boxed e-con e-parent" data-id="410572a" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"gradient\"}"}>
      					<div className="e-con-inner">
      		...
      		<div className="elementor-element elementor-element-8457be8 e-con-full e-flex e-con e-child" data-id="8457be8" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-element elementor-element-9cc4a8a elementor-icon-list--layout-inline elementor-list-item-link-inline elementor-tablet-align-left elementor-widget elementor-widget-icon-list" data-id="9cc4a8a" data-element_type="widget" data-e-type="widget" data-widget_type="icon-list.default">
      				<div className="elementor-widget-container">
      							<ul className="elementor-icon-list-items elementor-inline-items">
      							<li className="elementor-icon-list-item elementor-inline-item">
      											<span className="elementor-icon-list-icon">
      							<i aria-hidden="true" className="vamtamtheme- vamtam-theme-chack-circle"></i>						</span>
      										<span className="elementor-icon-list-text">Reliant Surveyors</span>
      									</li>
      						</ul>
      						</div>
      				</div>
      		...
      		<div className="elementor-element elementor-element-e93c4ba e-flex e-con-boxed e-con e-parent" data-id="e93c4ba" data-element_type="container" data-e-type="container">
      					<div className="e-con-inner">
      		<div className="elementor-element elementor-element-21413c9 e-con-full e-flex e-con e-child" data-id="21413c9" data-element_type="container" data-e-type="container">
      				<div className="elementor-element elementor-element-84992a9 elementor-invisible animated-fast elementor-widget elementor-widget-heading" data-id="84992a9" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\"}"} data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">Connect with Our Advisory Team</span>				</div>
      				</div>
      				<div className="elementor-element elementor-element-1460336 elementor-invisible elementor-widget__width-initial elementor-widget-tablet__width-inherit animated-fast elementor-widget elementor-widget-heading" data-id="1460336" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\",\"_animation_delay\":50}"} data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h2 className="elementor-heading-title elementor-size-default">Schedule an Advisory Consultation</h2>				</div>
      				</div>
      				<div className="elementor-element elementor-element-1c89791 elementor-invisible elementor-widget-tablet__width-initial animated-fast elementor-widget elementor-widget-heading" data-id="1c89791" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"fadeIn\",\"_animation_delay\":200}"} data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      		...
      		<a className="elementor-element elementor-element-a6db877 e-con-full e-flex e-con e-child" data-id="a6db877" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"classic\"}"} href="mailto:advisory@valunxtcapital.com?subject=Hello" target="_blank">
      				...
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-292350e elementor-view-default elementor-widget elementor-widget-icon" data-id="292350e" data-element_type="widget" data-e-type="widget" data-widget_type="icon.default">
      				<div className="elementor-widget-container">
      		...
      		<a className="elementor-element elementor-element-9ec2789 e-con-full e-flex e-con e-child" data-id="9ec2789" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"classic\"}"} href={`tel:${vxnOffice('dubai')!.tel}`} target="_blank">
      				<div className="elementor-element elementor-element-1c42ed5 elementor-view-stacked elementor-shape-rounded elementor-position-left elementor-widget-mobile__width-initial elementor-widget elementor-widget-icon-box" data-id="1c42ed5" data-element_type="widget" data-e-type="widget" data-widget_type="icon-box.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-icon-box-wrapper">
      				...
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-b825007 elementor-view-default elementor-widget elementor-widget-icon" data-id="b825007" data-element_type="widget" data-e-type="widget" data-widget_type="icon.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-icon-wrapper">
      			<div className="elementor-icon">
      			<i aria-hidden="true" className="vamtamtheme- vamtam-theme-arrow-right"></i>			</div>
      		...
      		<div className="elementor-element elementor-element-bca6cf1 e-con-full e-flex e-con e-child" data-id="bca6cf1" data-element_type="container" data-e-type="container">
      		<div className="elementor-element elementor-element-69901f9 elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="69901f9" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"classic\",\"animation\":\"slideInUp\"}"}>
      				<div className="elementor-element elementor-element-1732ca8 elementor-widget elementor-widget-heading" data-id="1732ca8" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h5 className="elementor-heading-title elementor-size-default">Book a Consultation</h5>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8625e1f elementor-invisible elementor-absolute animated-fast elementor-view-default elementor-widget elementor-widget-icon" data-id="8625e1f" data-element_type="widget" data-e-type="widget" data-settings={"{\"_position\":\"absolute\",\"_animation\":\"slideInRight\"}"} data-widget_type="icon.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-icon-wrapper">
      			<div className="elementor-icon">
      			<i aria-hidden="true" className="vamtamtheme- vamtam-theme-send"></i>			</div>
      		</div>
      						</div>
      				</div>
      				</div>
      		<div className="elementor-element elementor-element-0828ac2 e-con-full e-flex e-con e-child" data-id="0828ac2" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"classic\"}"}>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-e67e0ee elementor-button-align-stretch elementor-widget elementor-widget-form" data-id="e67e0ee" data-element_type="widget" data-e-type="widget" data-settings={"{\"button_width\":\"40\",\"step_next_label\":\"Next\",\"step_previous_label\":\"Previous\",\"step_type\":\"number_text\",\"step_icon_shape\":\"circle\"}"} data-widget_type="form.default">
      				<div className="elementor-widget-container">
      			...
      			<div className="elementor-form-fields-wrapper elementor-labels-above">
      								<div className="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-consult_full_name elementor-col-100 elementor-field-required">
      									<label htmlFor="form-field-consult_full_name" className="elementor-field-label">Full Name</label>
      									<input size={1} type="text" name="form_fields[consult_full_name]" id="form-field-consult_full_name" className="elementor-field elementor-size-sm  elementor-field-textual" placeholder="Full Name" required />
      								</div>
      								<div className="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-consult_email elementor-col-100 elementor-field-required">
      									<label htmlFor="form-field-consult_email" className="elementor-field-label">Email</label>
      									<input size={1} type="email" name="form_fields[consult_email]" id="form-field-consult_email" className="elementor-field elementor-size-sm  elementor-field-textual" placeholder="Email" required />
      								</div>
      								<div className="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-consult_phone elementor-col-100 elementor-field-required">
      									<label htmlFor="form-field-consult_phone" className="elementor-field-label">Phone No</label>
      									<input size={1} type="tel" name="form_fields[consult_phone]" id="form-field-consult_phone" className="elementor-field elementor-size-sm  elementor-field-textual" placeholder="Phone No" required />
      								</div>
      								<div className="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-consult_company elementor-col-100 elementor-field-required">
      									<label htmlFor="form-field-consult_company" className="elementor-field-label">Company Name</label>
      									<input size={1} type="text" name="form_fields[consult_company]" id="form-field-consult_company" className="elementor-field elementor-size-sm  elementor-field-textual" placeholder="Company Name" required />
      								</div>
      				...
      				<div className="elementor-element elementor-element-5548437 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="5548437" data-element_type="widget" data-e-type="widget" data-widget_type="divider.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-divider">
      			<span className="elementor-divider-separator">
      						</span>
      		...
      		<div className="elementor-element elementor-element-ffb46dc e-flex e-con-boxed e-con e-parent" data-id="ffb46dc" data-element_type="container" data-e-type="container">
      					<div className="e-con-inner">
      				<div className="elementor-element elementor-element-59eb87d elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="59eb87d" data-element_type="widget" data-e-type="widget" data-widget_type="divider.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-divider">
      			<span className="elementor-divider-separator">
      						</span>
      				...
      				<div className="elementor-element elementor-element-3c47df3 elementor-widget elementor-widget-heading" data-id="3c47df3" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">Supporting Investors, Developers, Institutions &amp; Businesses</span>				</div>
      				</div>
      				<div className="elementor-element elementor-element-9d489bf elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="9d489bf" data-element_type="widget" data-e-type="widget" data-widget_type="divider.default">
      				<div className="elementor-widget-container">
      							<div className="elementor-divider">
      			<span className="elementor-divider-separator">
      						</span>
      		...
      		<div className="elementor-element elementor-element-7f60690 e-flex e-con-boxed e-con e-parent" data-id="7f60690" data-element_type="container" data-e-type="container">
      					<div className="e-con-inner">
      										...
      										(function(){
      											...
      											function setDots(a){ for(var i=0;i<dots.length;i++){ var on=(i===a); dots[i].classList.toggle('is-active',on); dots[i].setAttribute('aria-selected', on?'true':'false'); } }
