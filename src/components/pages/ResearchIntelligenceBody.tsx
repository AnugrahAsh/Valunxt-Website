/**
 * /services/research-intelligence/ — page body.
 *
 * Port of services/research-intelligence/index.php. The captured Elementor markup is unchanged: the only
...
export default function ResearchIntelligenceBody({ page, region }: { page: PageConfig; region: string }) {
  return (
    <>
      ...
      <div id="main-content">
      	...
      	<div id="main" role="main" className="vamtam-main layout-full">
      		...
      		<article id="post-254" className="full post-254 page type-page status-publish has-post-thumbnail hentry">
      			<div data-elementor-type="single-page" data-elementor-id="3947" className="elementor elementor-3947 elementor-location-single post-254 page type-page status-publish has-post-thumbnail hentry" data-elementor-post-type="elementor_library">
      					...
      					<div className="e-con-inner">
      						<div className="elementor-element elementor-element-4e6911fc e-con-full e-flex e-con e-child" data-id="4e6911fc" data-element_type="container" data-e-type="container">
      							<div className="elementor-element elementor-element-3b31e9d e-con-full e-flex e-con e-child" data-id="3b31e9d" data-element_type="container" data-e-type="container">
      								...
      								<div className="elementor-element elementor-widget elementor-widget-heading vxn-crumb--services" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      									<div className="elementor-widget-container">
      										<span className="elementor-heading-title elementor-size-default"><a href={rurl(region, '/services/')}>&gt; Services</a></span>
      									</div>
      								</div>
      							...
      							<div className="elementor-element elementor-element-0a1120b e-con-full e-flex e-con e-child" data-id="0a1120b" data-element_type="container" data-e-type="container">
      								<div className="elementor-element elementor-element-bc5a61e elementor-invisible animated-fast elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading" data-id="bc5a61e" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\"}"} data-widget_type="theme-post-title.default">
      									<div className="elementor-widget-container">
      										<h1 className="elementor-heading-title elementor-size-default">Research &amp; Intelligence</h1>
      									</div>
      								</div>
      					...
      					<div className="elementor-element elementor-element-2b16d48e elementor-widget elementor-widget-theme-post-content" data-id="2b16d48e" data-element_type="widget" data-e-type="widget" data-widget_type="theme-post-content.default">
      						<div className="elementor-widget-container">
      							<div data-elementor-type="wp-page" data-elementor-id="254" className="elementor elementor-254" data-elementor-post-type="page">
      									...
      									<div className="e-con-inner">
      										...
      										<div className="elementor-element elementor-element-356d69e3 e-con-full e-flex e-con e-child" data-id="356d69e3" data-element_type="container" data-e-type="container">
      											<div className="elementor-element elementor-element-310b5471 elementor-invisible animated-fast elementor-widget elementor-widget-heading" data-id="310b5471" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\"}"} data-widget_type="heading.default">
      												<div className="elementor-widget-container">
      													<span className="elementor-heading-title elementor-size-default">What We Do</span>
      												</div>
      											</div>
      								...
      								<section className="vxn-offer" style={{ '--vxn-offer-img': `url('${BASE}/assets/content/uploads/services/research-and-intelligence.webp')` } as React.CSSProperties}>
      									<div className="vxn-offer__inner">
      										<div className="vxn-offer__content">
      											<span className="vxn-offer__label">Services Offered</span>
      											<h2 className="vxn-offer__heading">Our Research and Intelligence Services</h2>
      											<p className="vxn-offer__sub">We support confident investment decisions with independent research, valuation intelligence, and disciplined market analysis.</p>
      											<div className="vxn-offer__grid">
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-growth" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Market Intelligence &amp; Investment Research</span>
      												</div>
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-chack-circle" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Valuation Intelligence &amp; Development Advisory</span>
      												</div>
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-direction" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Feasibility &amp; Highest and Best Use Studies</span>
      												</div>
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-doppler-effect" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Market Forecasting &amp; Economic Research</span>
      												</div>
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-location" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Location Intelligence &amp; Risk Assessment</span>
      												</div>
      												<div className="vxn-offer__item">
      													<span className="vxn-offer__icon"><i className="vamtamtheme- vamtam-theme-circular-geometric" aria-hidden="true"></i></span>
      													<span className="vxn-offer__text">Portfolio Analytics &amp; Scorecards</span>
      												</div>
      											</div>
      										</div>
      									</div>
      										...
      										<div className="e-con-inner">
      											<div className="elementor-element elementor-element-3fef7bed e-con-full e-flex e-con e-child" data-id="3fef7bed" data-element_type="container" data-e-type="container">
      												...
      												<div className="elementor-element elementor-element-5e74a39b elementor-invisible elementor-widget-tablet__width-inherit animated-fast elementor-widget elementor-widget-heading" data-id="5e74a39b" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\",\"_animation_delay\":50}"} data-widget_type="heading.default">
      													<div className="elementor-widget-container">
      														<h2 className="elementor-heading-title elementor-size-default">Our Advisory Engagement Process</h2>
      													</div>
      												</div>
      												...
      												<div className="elementor-element elementor-element-2ab9dfc1 elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="2ab9dfc1" data-element_type="container" data-e-type="container" data-settings={"{\"animation\":\"slideInUp\",\"animation_delay\":150}"}>
      													<div className="elementor-element elementor-element-2067551 elementor-widget elementor-widget-heading" data-id="2067551" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      														<div className="elementor-widget-container">
      															<h5 className="elementor-heading-title elementor-size-default">Initial Consultation and Scoping</h5>
      														</div>
      													</div>
      												...
      												<div className="elementor-element elementor-element-6ed5c612 elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="6ed5c612" data-element_type="container" data-e-type="container" data-settings={"{\"animation\":\"slideInUp\",\"animation_delay\":200}"}>
      													<div className="elementor-element elementor-element-7293b296 elementor-widget elementor-widget-heading" data-id="7293b296" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      														<div className="elementor-widget-container">
      															<h5 className="elementor-heading-title elementor-size-default">Discovery</h5>
      														</div>
      													</div>
      												...
      												<div className="elementor-element elementor-element-20674be elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="20674be" data-element_type="container" data-e-type="container" data-settings={"{\"animation\":\"slideInUp\",\"animation_delay\":250}"}>
      													<div className="elementor-element elementor-element-42f52363 elementor-widget elementor-widget-heading" data-id="42f52363" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      														<div className="elementor-widget-container">
      															<h5 className="elementor-heading-title elementor-size-default">Intelligence</h5>
      														</div>
      													</div>
      												...
      												<div className="elementor-element elementor-element-7e472958 elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="7e472958" data-element_type="container" data-e-type="container" data-settings={"{\"animation\":\"slideInUp\",\"animation_delay\":300}"}>
      													<div className="elementor-element elementor-element-3d87cb47 elementor-widget elementor-widget-heading" data-id="3d87cb47" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      														<div className="elementor-widget-container">
      															<h5 className="elementor-heading-title elementor-size-default">Advisory</h5>
      														</div>
      													</div>
      								...
      								<div className="elementor-element elementor-element-4eb87f08 e-con-full e-flex e-con e-parent" data-id="4eb87f08" data-element_type="container" data-e-type="container">
      									<div className="elementor-element elementor-element-7e4ee057 e-con-full e-flex e-con e-child" data-id="7e4ee057" data-element_type="container" data-e-type="container" data-settings={"{\"background_background\":\"classic\",\"background_motion_fx_motion_fx_scrolling\":\"yes\",\"background_motion_fx_scale_effect\":\"yes\",\"background_motion_fx_devices\":[\"desktop\"],\"background_motion_fx_scale_direction\":\"out-in\",\"background_motion_fx_scale_speed\":{\"unit\":\"px\",\"size\":4,\"sizes\":[]},\"background_motion_fx_scale_range\":{\"unit\":\"%\",\"size\":\"\",\"sizes\":{\"start\":20,\"end\":80}}}"}>
      										<div className="elementor-element elementor-element-93326d5 e-flex e-con-boxed e-con e-child" data-id="93326d5" data-element_type="container" data-e-type="container">
      											<div className="e-con-inner">
      												<div className="elementor-element elementor-element-54903b82 e-con-full e-flex e-con e-child" data-id="54903b82" data-element_type="container" data-e-type="container">
      													<div className="elementor-element elementor-element-5ae1d969 elementor-invisible animated-fast elementor-widget elementor-widget-heading" data-id="5ae1d969" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\",\"_animation_delay\":50}"} data-widget_type="heading.default">
      														<div className="elementor-widget-container">
      								...
      								<div className="elementor-element elementor-element-43268fcc e-flex e-con-boxed e-con e-child" data-id="43268fcc" data-element_type="container" data-e-type="container">
      									<div className="e-con-inner">
      										<div className="elementor-element elementor-element-5f8b54ab elementor-invisible animated-fast elementor-widget elementor-widget-heading" data-id="5f8b54ab" data-element_type="widget" data-e-type="widget" data-settings={"{\"_animation\":\"slideInUp\"}"} data-widget_type="heading.default">
      											<div className="elementor-widget-container">
      												<span className="elementor-heading-title elementor-size-default">Our Services</span>
      											</div>
      										</div>
      										<div className="elementor-element elementor-element-522bfd1c e-con-full e-flex e-con e-child" data-id="522bfd1c" data-element_type="container" data-e-type="container">
      											<div className="elementor-element elementor-element-202ab71a e-con-full e-flex e-con e-child" data-id="202ab71a" data-element_type="container" data-e-type="container">
      												<div className="elementor-element elementor-element-2dd02186 e-con-full e-flex e-con e-child" data-id="2dd02186" data-element_type="container" data-e-type="container">
      											...
      											<div className="elementor-element elementor-element-6a8545de e-con-full e-flex e-con e-child" data-id="6a8545de" data-element_type="container" data-e-type="container">
      												...
      												<div className="elementor-element elementor-element-159405b5 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="159405b5" data-element_type="widget" data-e-type="widget" data-widget_type="divider.default">
      													<div className="elementor-widget-container">
      														<div className="elementor-divider">
      															<span className="elementor-divider-separator">
      															</span>
      												...
      												<div className="elementor-element elementor-element-494db1dd elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="494db1dd" data-element_type="widget" data-e-type="widget" data-widget_type="divider.default">
      													<div className="elementor-widget-container">
      														<div className="elementor-divider">
      															<span className="elementor-divider-separator">
      															</span>
