 ...
 *
 * Port of privacy-policy/index.php. The captured Elementor markup is unchanged: the only
...
export default function PrivacyPolicyBody({ page, region }: { page: PageConfig; region: string }) {
  return (
    <>
      ...
      <div id="main-content">
      		...
      		<article id="post-3" className="full post-3 page type-page status-publish hentry">
      				<div data-elementor-type="single-page" data-elementor-id="3752" className="elementor elementor-3752 elementor-location-single post-3 page type-page status-publish hentry" data-elementor-post-type="elementor_library">
      		...
      		<div className="elementor-element elementor-element-7b36cfb e-con-full e-flex e-con e-child" data-id="7b36cfb" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">&gt; Privacy Policy</span>				</div>
      				</div>
      				</div>
      		...
      		<div className="elementor-element elementor-element-8c0b074 e-con-full e-flex e-con e-child" data-id="8c0b074" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h1 className="elementor-heading-title elementor-size-default">Privacy Policy Information</h1>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h2 className="elementor-heading-title elementor-size-default">Privacy Policy</h2>				</div>
      				</div>
      				</div>
      				</div>
      					</div>
      		...
      		<div className="elementor-element elementor-element-44f0fa2 e-con-full e-flex e-con e-child" data-id="44f0fa2" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">What information do we collect?</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      									<p>When you interact with us, we may collect your name, address, email address(es), telephone number(s), and, where appropriate, date of birth.</p>								</div>
      				</div>
      				<div className="elementor-element elementor-element-08b3a2b elementor-widget elementor-widget-heading" data-id="08b3a2b" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">How do we collect information?</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-f109c8e elementor-widget elementor-widget-text-editor" data-id="f109c8e" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      									<p>We may collect information about you whenever you interact with us. For example, when you contact us regarding our advisory services, register your interest, send or receive information or submit an enquiry, you specifically and knowingly provide us with your personal information. We may also receive information about you from third parties – but only if you have given them permission to share your information.</p>								</div>
      				</div>
      				<div className="elementor-element elementor-element-e08c843 elementor-widget elementor-widget-heading" data-id="e08c843" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Confidentiality</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Making a complaint
      </h3>				</div>
      				</div>
