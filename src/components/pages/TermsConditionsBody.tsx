 ...
 *
 * Port of terms-conditions/index.php. The captured Elementor markup is unchanged: the only
...
export default function TermsConditionsBody({ page, region }: { page: PageConfig; region: string }) {
  return (
    <>
      ...
      <div id="main-content">
      		...
      		<article id="post-2034" className="full post-2034 page type-page status-publish hentry">
      				<div data-elementor-type="single-page" data-elementor-id="3752" className="elementor elementor-3752 elementor-location-single post-2034 page type-page status-publish hentry" data-elementor-post-type="elementor_library">
      		...
      		<div className="elementor-element elementor-element-7b36cfb e-con-full e-flex e-con e-child" data-id="7b36cfb" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">&gt; Terms &amp; Conditions</span>				</div>
      				</div>
      				</div>
      		...
      		<div className="elementor-element elementor-element-8c0b074 e-con-full e-flex e-con e-child" data-id="8c0b074" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h1 className="elementor-heading-title elementor-size-default">Terms &amp; Conditions</h1>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h2 className="elementor-heading-title elementor-size-default">Terms &amp; Conditions</h2>				</div>
      				</div>
      				</div>
      				</div>
      					</div>
      		...
      		<div className="elementor-element elementor-element-afe1311 e-con-full e-flex e-con e-parent" data-id="afe1311" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      							<div data-elementor-type="wp-page" data-elementor-id="2034" className="elementor elementor-2034" data-elementor-post-type="page">
      				<div className="elementor-element elementor-element-bdb515c e-flex e-con-boxed e-con e-parent" data-id="bdb515c" data-element_type="container" data-e-type="container">
      					<div className="e-con-inner">
      		<div className="elementor-element elementor-element-7b882be e-con-full e-flex e-con e-child" data-id="7b882be" data-element_type="container" data-e-type="container">
      				<div className="elementor-element elementor-element-b41953f elementor-widget elementor-widget-heading" data-id="b41953f" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Comments</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Media</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Cookies</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Embedded content from other websites</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Who we share your data with</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">How long we retain your data</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">What rights you have over your data</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Where your data is sent</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-bd5cd5a elementor-widget elementor-widget-text-editor" data-id="bd5cd5a" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      									<p>Visitor enquiries and comments may be checked through an automated spam detection service.</p>								</div>
      				</div>
      				</div>
      					</div>
      				</div>
